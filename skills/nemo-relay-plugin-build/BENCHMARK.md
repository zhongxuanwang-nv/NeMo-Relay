# Skill Benchmark: nemo-relay-plugin-build
...
- Dataset digest: `sha256:c8403ee1b7460312e49238c2b1fb6278c21b125e44f94b87bbe76ddf1cb710b6` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
- **MEDIUM** SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/nemo-relay-plugin-build/SKILL.md`)
- **MEDIUM** SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/nemo-relay-plugin-build/SKILL.md`)
- **LOW** SCHEMA/author_format: Author must be of the form 'Name <email@host>' (`skills/nemo-relay-plugin-build/SKILL.md`)
