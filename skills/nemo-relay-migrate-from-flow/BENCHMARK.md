# Skill Benchmark: nemo-relay-migrate-from-flow
...
- Dataset digest: `sha256:738c9da141c6937b5a549c6cce2751d6b1786921b3eb39fa345e7e2ac44f8fac` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
- **MEDIUM** SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/nemo-relay-migrate-from-flow/SKILL.md`)
- **MEDIUM** SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/nemo-relay-migrate-from-flow/SKILL.md`)
- **LOW** SCHEMA/author_format: Author must be of the form 'Name <email@host>' (`skills/nemo-relay-migrate-from-flow/SKILL.md`)
